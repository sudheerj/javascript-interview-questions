...
پرسش و پاسخ‌های پیش رو، حاصل گردآوری سوالات پرتکراری‌ست که در جلسات مصاحبه‌ برای موقعیت‌‌های کاری مرتبط با جاواسکریپت پرسیده می‌شود. 
...
40. ### تفاوت‌های بین cookie، local-storage و session-storage چیا هستن؟
    ...
    | پشتیبانی از SSL | پشتیبانی می‌شود | پشتیبانی نمی‌شه | پشتیبانی نمی‌شه |
