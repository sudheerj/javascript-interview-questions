...
45. ### رخداد storage چیه و چطوری ازش استفاده می‌کنیم؟
     ...
     StorageEvent رویدادی هستش که با همزمان با تغییر یه محل ذخیره‌سازی در یه context صفحه دیگه‌ای فراخوانی می‌شه. این امکان بهمون قابلیت پردازش تغییرات مقادیر ذخیره‌سازی شده توسط یه EventHandler رو میده. ساختار کد اون یه چیزی مث کد زیر میشه:
